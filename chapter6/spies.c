/*
 * Program to learn about memory leaks and how to find them using valgrind
 */
...
struct node* create (char *question)
{
...
int main()
{
        ...
        struct node *start_node = create("Does suspect have a mustache");
        ...
        do {
                ...
                while (1) {
                        if (yes_no(current->question))
                        {
                                ...
                                struct node *yes_node = create(suspect);
                                current->yes = yes_node;
                                
                                // Make the no-node a copy of this question
                                struct node *no_node = create(current->question);
                                current->no = no_node;
